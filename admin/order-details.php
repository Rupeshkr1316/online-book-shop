            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" cellspacing="0" style="width:100%;">
                  ...
                  <tbody>
                    <?php
                    $str = mysqli_query($conn, "select * from order_d ORDER BY id ASC");
                    ...
                    ?>
                      ...
                      <tr class="primary">
                        ...
                        <td>
                          <?php
                          $status = $data['status'];
                          $options = array('pending', 'confirm', 'cancel');
                          ?>
                          <form action="update_status.php" method="POST">
                            ...
                            <input type="submit" name="submit" class="btn btn-warning ml-2" value="Update">
                          </form>
                        </td>
                        <td><a href="orderdet.php?id=<?php echo $id; ?>"><button class="btn btn-success">Bill & See Details</button></a></td>
                        <td><a href="orderdelete.php?id=<?php echo $id; ?>" onclick="return confirm('Are You Sure To Delete ?')"><button class="btn btn-danger">Delete</button></a></td>
                      </tr>
                    <?php
                    }
                    ?>
