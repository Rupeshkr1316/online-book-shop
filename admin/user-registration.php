              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" cellspacing="0" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    $str = mysqli_query($conn, "select * from register ORDER BY id ASC");
                    ...
                    ?>
                      ...
                      <tr class="primary">
                        ...
                        <td><?php echo "*********"; ?></td>
                        <td>
                          <a href="userupdate.php?id=<?php echo $id; ?>"><button class="btn btn-dark">Update</button></a>
                        </td>
                        <td>
                          <a href="userdelete.php?id=<?php echo $id; ?>" onclick="return confirm('Are You Sure To Delete ?')"><button class="btn btn-danger">Delete</button></a>
                        </td>
                      </tr>
                    <?php
                    }
